...
{   
    ...
    typedef std::array<BYTE, DWORD_BYTES> DWORD;
    ...
    private:
        ...
        static BranchChanger::DWORD GetAddressBytes( const std::size_t & int_byte )
        {
            ...
            BranchChanger::DWORD dword = {
                static_cast<BYTE>( int_byte & 0xFF ),
                static_cast<BYTE>( ( int_byte >> 8 ) & 0xFF ),
                static_cast<BYTE>( ( int_byte >> 16 ) & 0xFF ),
                static_cast<BYTE>( ( int_byte >> 24 ) & 0xFF )
            };
        ...
        void PrepareBranch( bool condition = true )
        {   
    ...
    public:
        ...
        void set_direction(bool condition) 
        {
            ...
            memcpy(branch_bytecode_, bytecode_[condition].data(), DWORD_BYTES);
        }
};
